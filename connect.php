...
*/
	...
	$pdo = new PDO('mysql:dbname=biomio_db_test; host=127.0.0.1; port=3309', 'biomio_admin', 'admin');
	...
	$db_conx = mysqli_connect ("127.0.0.1", "biomio_admin", "admin", "biomio_db_test","3309")
	or die (mysqli_connect_error());