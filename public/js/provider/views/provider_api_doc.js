App.Views.ProviderApiDoc = Backbone.View.extend({
    el: $("#content"),
    initialize: function () {
    },
    render: function () {
        var template = render('ProviderAPIDocView', {});
        this.$el.html(template);
    },
});

App.Views.ProviderLoginDoc = Backbone.View.extend({
    el: $("#content"),
    initialize: function () {
    },
    render: function () {
        var template = render('ProviderLoginDoc', {});
        this.$el.html(template);
    },
});
