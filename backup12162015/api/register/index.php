...
<div class="container">
  ...
  <div class="row" style="margin-top: 20px">
      <div class="well">
        ...
        <p><code>{hash: hash, time: time, public_key: public_key, email: email}</code></p>
        <br>
        ...
        <br>
          ...
          <p><code>{hash: hash, time: time, public_key: public_key, profileId: profileId, first_name: first_name, last_name: last_name}</code></p>
          <br>
          <p><strong>Possible responses:</strong></p>
        ...
        <br>
          ...
          <p><code>{hash: hash, time: time, public_key: public_key, profileId: profileId, device_name: device_name}</code></p>
          <br>
          <p><strong>Possible responses:</strong></p>
          <p>{'device_id': '12345678'} <span style="color: #bbb">// id of registered device (unverified)</span></p>
          <p>{'response': '#user'} <span style="color: #bbb">// this user is not associated with you</span></p>
        <br>
          <p>3.3 Register mobile device:</p>
          <p><code>POST: https://biom.io/api/register/generate_device_code/</code></p>
          <p><code>{hash: hash, time: time, public_key: public_key, profileId: profileId, device_id: device_id}</code></p>
          <br>
          <p><strong>Possible responses:</strong></p>
          <p>{'code': '12345678'} <span style="color: #bbb">// code to check device verification</span></p>
          <p>{'response': '#user'} <span style="color: #bbb">// this user is not associated with you</span></p>
        ...
        <br>
          ...
          <p><code>{hash: hash, time: time, public_key: public_key, profileId: profileId, code: code}</code></p>
          <br>
          <p><strong>Possible responses:</strong></p>
          <p>{'response': '#user'} <span style="color: #bbb">// this user is not associated with you</span></p>
        ...
        <br>
          ...
          <p><code>{hash: hash, time: time, public_key: public_key, profileId: profileId}</code></p>
          <br>
          <p><strong>Possible responses:</strong></p>
