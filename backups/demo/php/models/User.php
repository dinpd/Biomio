...
class User {
  ...
  public static function update_temp_login_code($profileId, $status) {
	...
	$result =  mysqli_query($db_conx, "UPDATE TempLoginCodes SET status = $status WHERE profileId = $profileId") or die (mysqli_error());
	return $result;
  }
  ...
  public static function insert_temp_login_codes($profileId, $code) {
	...
	$result =  mysqli_query($db_conx, "INSERT INTO TempLoginCodes (profileId, code, date_created) VALUES ($profileId, '$code', now())") or die (mysqli_error()); 
	return $result;
  }
  ...
  public static function select_temp_login_phone($profileId, $phone) {
	...
	$result = mysqli_query($db_conx, "SELECT * FROM Profiles WHERE id = $profileId AND phones LIKE '%$phone%'") or die (mysqli_error());
	return $result;
  }
  ...
  public static function select_temp_login_email($profileId, $email) {
	...
	$result = mysqli_query($db_conx, "SELECT * FROM Profiles WHERE id = $profileId AND emails LIKE '%$email%'") or die (mysqli_error());
	return $result;
  }
  ...
  public static function select_temp_login_code($profileId, $code) {
	...
	$result = mysqli_query($db_conx, "SELECT * FROM TempLoginCodes WHERE profileId = $profileId AND code = '$code' AND status = 1 AND date_created > DATE_SUB(now(), INTERVAL 15 MINUTE)") or die (mysqli_error());
	return $result;
  }
  ...
  public static function update_temp_email_codes($profileId, $status) {
	...
	$result =  mysqli_query($db_conx, "UPDATE TempPhoneCodes SET status = $status WHERE profileId = $profileId") or die (mysqli_error());
	return $result;
  }

  public static function insert_temp_email_codes($profileId, $code, $phone) {
	include ('connect.php');

	$result =  mysqli_query($db_conx, "INSERT INTO TempPhoneCodes (profileId, code, email, date_created) VALUES ($profileId, '$code', '$phone', now())") or die (mysqli_error()); 
	return $result;
  }

  public static function select_temp_email_codes($profileId, $code) {
	include ('connect.php');

	$result = mysqli_query($db_conx, "SELECT * FROM TempPhoneCodes WHERE profileId = $profileId AND code = '$code' AND status = 1 AND date_created > DATE_SUB(now(), INTERVAL 15 MINUTE)") or die (mysqli_error());
	return $result;
  }
  ...
  public static function insert_temp_phone_codes($profileId, $code, $phone) {
	...
	$result =  mysqli_query($db_conx, "INSERT INTO TempPhoneCodes (profileId, code, phone, date_created) VALUES ($profileId, '$code', '$phone', now())") or die (mysqli_error()); 
	return $result;
  }
