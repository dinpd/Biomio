App.Views.ProviderInformation = Backbone.View.extend({
    ...
    render:function () {
        ...
        $.ajax({
            url: 'profileData/companyLogo/' + window.profileName + '.jpg',
            success: function (data) {
                $('#provider_image_preview').html('<img id="provider_image" class="col-sm-12" style="padding: 0px" src ="profileData/companyLogo/' + window.profileName + '.jpg?' + time +'">');
...
function providerSaveImage () {
    ...
    formdata.append("provider", window.profileName);
