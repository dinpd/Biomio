	...
	render:function () {
		if (this.model.id) {
	        ...
	        $.ajax({
	            ...
	            error: function (data) {
	                $('#location_image_preview').html('<img id="location_image" class="col-sm-12" style="padding: 0px; width: 100%" src ="images/house.png">');
                }
	        });
		} else {
    ...
    $.ajax({
        ...
        success:function(data){
            if(data == "Success"){          
                ...
                $('#location_image_preview').html('<img id="location_image" class="col-sm-12" style="padding: 0px" src ="images/house.png">');
